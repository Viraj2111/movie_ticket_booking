...
import 'package:movie_booking/enums/lodingState.dart';
    ...
    return Center(
      child: TextButton(
        ...
        child: FittedBox(
          ...
          child: loadingState == LoadingState.inprogress
              ?   CircularProgressIndicator(
                  color: buttonColor == primaryWhite ? Color(0xff6320EE) : primaryWhite,
                  strokeWidth: 1,
                )
              : Text(
                  loadingState == LoadingState.error? "Try Again!":title.toString(),
                  softWrap: true,
